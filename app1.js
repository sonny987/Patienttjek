...
function applyBrightness(val){
  ...
  // 0 = fuld mørk, 100 = fuld lys
  // Blend between dark vars and light vars using CSS filter + custom properties
  ...
  if(val <= 0){
    ...
    // Partial: use light mode + dim with brightness filter
    document.body.classList.add('light-mode');
    const brightness = 0.4 + (val / 100) * 0.6; // 0.4 to 1.0
